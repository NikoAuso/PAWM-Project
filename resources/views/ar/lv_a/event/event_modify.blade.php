...
@section('content')
            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-lg-auto mb-3">
                        @if(!$data->isJolly)
                            <a class="btn btn-warning mb-1" href="{{route('lv_a.tables.display_event', $data->id)}}">
                                <i class="fas fa-glass-martini-alt"></i>
                            </a>
                            <a class="btn btn-success mb-1" href="{{route('lv_a.lists.event', $data->id)}}">
    ...
    <!-- Main page content-->
    <form action="{{route('lv_a.events.edit_save', ['id' => $data->id])}}" method="post"
            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-footer">
                        <a href="{{route('lv_a.events.delete', [$data->id])}}" class="btn btn-primary pull-left">Si</a>
