    ...
    <div class="card mb-3 card-horizontal">
        <div class="row g-0 justify-content-between">
            ...
            <div class="col-md-2 col-lg-1 text-center" id="action-btn-event">
                @if(!$event->isJolly)
                    <a class="btn btn-warning mb-2" href="{{route('lv_a.tables.display_event', ['id' => $event->id])}}">
                        <i class="fas fa-glass-martini-alt"></i>
                    </a>
                    <a class="btn btn-success mb-2" href="{{route('lv_a.lists.event', ['id' => $event->id])}}">
                ...
                @endif
                <a class="btn btn-primary mb-2" href="{{route('lv_a.events.edit', ['id' => $event->id])}}">
