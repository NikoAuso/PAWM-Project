                ...
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-auto align-items-right mb-3">
                        <a class="btn btn-sm btn-light text-primary"
                           href="{{route('lv_a.user.insert', ['page' => basename($_SERVER['REQUEST_URI'])])}}">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a type="button" class="btn btn-primary"
                                                   href="{{route('lv_a.user.edit', ['id' => $user->id, 'page' => basename($_SERVER['REQUEST_URI'])])}}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a type="button" class="btn btn-secondary"
                                                   href="{{route('lv_a.user.profile', ['id' => $user->id])}}"><i
                                                        class="fas fa-eye"></i></a>
                                                <a type="button" href="#" class="btn btn-danger delete-btn"
                                                   data-bs-toggle="modal"
                                                   data-bs-target="#confirm-delete"
                                                   data-link="{{route('lv_a.user.delete_save', ['id' => $user->id, 'page' => (basename($_SERVER['REQUEST_URI']))])}}"
