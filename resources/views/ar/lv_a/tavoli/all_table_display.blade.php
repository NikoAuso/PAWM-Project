    ...
    <div class="container-xl px-4 mt-5">
        <div class="row">
            <div class="col-xl-12 col-sm-12 mb-12">
                <!-- Form ricerca tavoli -->
                <form class="form mb-4 mt-2" action="{{route('lv_a.tables.search')}}" method="post"
                    ...
                    <div class="form-row">
                        <div class="input-group mb-3">
                            ...
                            <a type="button" class="btn btn-dark" href="{{route('lv_a.tables.display_all')}}">
                                Cancella filtro
                            </a>
                        </div>
                    </div>
                                ...
                                @if(count($tables))
                                    ...
                                    @foreach($tables as $table)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('lv_a.events.edit', $result->id)}}">{{$result->titolo}}</a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="#" class="btn btn-danger p-3 shadow delete_btn"
                                                       ...
                                                       data-link="{{ route('lv_a.tables.delete', $table->id) }}">
                                        ...
                                        <div class="modal fade" id="table-update-{{$table->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form"
                                                          action="{{route('lv_a.tables.update', $table->id)}}"
...
@section('scripts')
    ...
    <div class="modal fade" id="storeTableModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form class="form" id="closingSeason" method="post" action="{{route('lv_a.tables.store')}}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
