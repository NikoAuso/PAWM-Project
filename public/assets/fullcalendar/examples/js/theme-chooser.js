function initThemeChooser(settings) {
    ...
    let currentThemeSystem; // don't set this directly. use setThemeSystem
    let currentStylesheetEl;
    let loadingEl = document.getElementById('loading');
    let systemSelectEl = document.querySelector('#theme-system-selector select');
    let themeSelectWrapEls = Array.prototype.slice.call( // convert to real array
    ...
    themeSelectWrapEls.forEach(function (themeSelectWrapEl) {
        let themeSelectEl = themeSelectWrapEl.querySelector('select');
    ...
    function setTheme(themeSystem, themeName) {
        let stylesheetUrl = generateStylesheetUrl(themeSystem, themeName);
        let stylesheetEl;
